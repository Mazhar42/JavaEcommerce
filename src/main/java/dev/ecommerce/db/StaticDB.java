...
public class StaticDB {
    ...
    public static void initDB(){
        ...
        products.add(new Product(2L,"101002","Asus", "Laptop",799.99));
        products.add(new Product(3L,"101003","One Plus 9 pro", "Mobile Phone",649.99));
        products.add(new Product(4L,"101004","LG g7 ThinQ", "Mobile Phone",349.99));
    }
}
